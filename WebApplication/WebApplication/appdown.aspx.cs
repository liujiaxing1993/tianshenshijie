...
namespace WebApplication
{
    public partial class appdown : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //Response.Write(CheckAgent());
            //DoGetRequestSendData("https://count.xxxssk.com?1217");
            //string urlcomeStr = CheckAgent();
            //if (urlcomeStr == "Android")
            //{
            //    Response.Redirect("https://play.google.com/store/apps/details?id=com.asiaxokj.tssj");
            //}
            //else if (urlcomeStr == "iPhone" || urlcomeStr == "iPod" || urlcomeStr == "iPad")
            //{
            //    Response.Redirect("https://apps.apple.com/hk/app/id1504376912?l=zh&ls=1");
