...
<script>
    ...
    if (jurl == "") {
        console.log("滴滴滴滴")
        location.href = "https://www.tianshenshijie.com/page.aspx?pid=960#VIP888";
    } else {
        console.log(document.location);
        location.href = "https://www.tianshenshijie.com/page.aspx" + (document.location.search + document.location.hash);
    }
    // 判断安卓
    function isAndroid() {
    ...
    function urlJump() {
        if (isIos()) {
            //setIdDisplay('apple_download', 'none');
            //setIdDisplay('download', 'none');
